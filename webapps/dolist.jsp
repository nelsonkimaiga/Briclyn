...
//    conn=dbConn.getConnection();
	...
	String ititle = request.getParameter("title");
        String iTransactionType=request.getParameter("tranType").toString();
	String iPropertyID=request.getParameter("propertyType").toString();
	String sPropertyAddress=request.getParameter("sPropertyAddress");
	String iCityID=request.getParameter("iCityID").toString();
	String iLocalityID=request.getParameter("iLocation").toString();
	...
	try{
		sqlInsertlist_requirement="insert into listings(sUserID, iTitle, iTransactionType, iPropertyID, sPropertyAddress, iCityID, iLocalityID, iArea, iTotalPrice, iBaths, cStatus, sCreatedBy, dCreatedDate)"
									+"values('"+sSessionUserID+"', '"+ititle+"', '"+iTransactionType+"', '"+iPropertyID+"', '"+sPropertyAddress+"', '"+iCityID+"', '"+iLocalityID+"', '"+iArea+"', '"+iTotalPrice+"', '"+iBedroom+"', '"+appYes+"', '"+sSessionUserID+"', sysdate())";
